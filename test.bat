...
python updatetask.py tasks\some_task to_review
python updatetask.py tasks\some_task fail_review
python updatetask.py tasks\some_task to_check
python updatetask.py tasks\some_task fail_check
python updatetask.py tasks\some_task start_fix
python updatetask.py tasks\some_task to_done
python updatetask.py tasks\some_task to_problem
